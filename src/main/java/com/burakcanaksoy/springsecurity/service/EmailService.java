...
public class EmailService {
    ...
    public void sendVerificationEmail(Employee employee, VerificationToken token) {
        String subject = "Email Verification";
        String verificationUrl = "http://localhost:9094/api/v1/auth/verify?token=" + token.getToken();
