...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> verifyOtp(Authentication authentication ,@RequestParam String code) {
        return ResponseEntity.ok(authService.verifyOtp(authentication.getName(),code));
    }
